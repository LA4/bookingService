...
import {
  BookingResponse,
  MessageResponse,
} from '../dto/response/BookingResponse';
...
import {
  BookingResponseSwagger,
  MessageResponseSwagger,
} from '../dto/response/BookingResponse.swagger';
...
export class BookingController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieves all bookings of all users in the system',
  })
  @ApiBearerAuth()
  @UseGuards(AdminGuard)
  @ApiResponse({
    status: 200,
    description: 'List of all users bookings',
  ...
  @ApiOperation({
    ...
    description: 'Refunds a cancelled booking',
  })
  @UseGuards(AdminGuard)
  ...
  @ApiResponse({
    ...
    type: MessageResponseSwagger,
  })
  @ApiResponse({
    status: 400,
    description: 'Only cancelled bookings can be refunded',
  })
  ...
  @ApiBody({
    type: CreateBookingRequestSwagger,
  ...
  @ApiOperation({
    ...
    description: 'Updates booking status and seat information',
  })
  @ApiParam({ name: 'id', description: 'Booking ID' })
  ...
  @ApiResponse({
    status: 400,
    description: 'Booking already cancelled or refunded',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized - not booking owner' })
  @ApiResponse({ status: 404, description: 'Booking not found' })
  async cancel(
